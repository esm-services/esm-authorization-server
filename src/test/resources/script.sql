...
COMMENT ON DATABASE "EMPLOYEE_DB" IS 'DB for employee data';

GRANT ALL ON DATABASE "EMPLOYEE_DB" TO rdurgesh;

GRANT TEMPORARY, CONNECT ON DATABASE "EMPLOYEE_DB" TO PUBLIC;
--------------------------------------------------------------------------
...
CREATE SEQUENCE S_EMPLOYEE START 1001;
DROP TABLE IF EXISTS T_EMPLOYEE;
CREATE TABLE T_EMPLOYEE(
	EMPLOYEE_ID BIGINT PRIMARY KEY,
	EMPLOYEE_UID VARCHAR(10) UNIQUE,
	FIRST_NAME VARCHAR(20),
	LAST_NAME VARCHAR(20),
	DATE_OF_BIRTH BYTEA,
	DATE_OF_JOINING BYTEA,
	DATE_OF_LEAVING BYTEA,
